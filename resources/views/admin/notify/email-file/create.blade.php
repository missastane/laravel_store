...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb text-center">
        ...
        <li class="breadcrumb-item font-size-12"><a href="{{route('admin.notify.email-file.index', $email->id)}}">فایل اطلاعیه ایمیلی</a></li>
    ...
    <section class="col-12 py-2">
        <section class="main-body-container">
            ...
            <section class="d-flex justify-content-between align-items-center my-4">
                <a class="btn btn-dark btn-sm" href="{{route('admin.notify.email-file.index', $email->id)}}">بازگشت</a>
            ...
            <form action="{{route('admin.notify.email-file.store', $email->id)}}" method="post" enctype="multipart/form-data">
                <section class="row">
                    ...
                    <section class="col-12 py-2">
                        ...
                        <section class="col-md-6 py-5">
                            <div class="form-group">
                                <section class="d-flex justify-content-md-between">
                                <section>
                                        <label for="file" class="btn btn-primary mx-5">بارگذاری فایل
                                             ایمیل</label>
                                             <div class="mt-1 p-1 border rounded bg-danger text-white mx-5 d-none" id="file-upload-filename"></div>
                                        <input type="file" 
