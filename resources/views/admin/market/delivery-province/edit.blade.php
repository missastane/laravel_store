...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb text-center">
        ...
        <li class="breadcrumb-item active font-size-12" aria-current="page">ویرایش استان</li>
    </ol>
</nav>
<section class="row">
    <section class="col-12">
        <section class="main-body-container">
            ...
            <section>
            <form action="{{route('admin.market.delivery-province.update', $province->id)}}" method="post">
                <section class="row">
                    @csrf
                    @method('put')
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control form-control-sm" value="{{old('name', $province->name)}}" type="text" name="name" id="name">
                    </div>
                    @error('name')
