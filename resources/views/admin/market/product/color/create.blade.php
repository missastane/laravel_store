...
@section('head-tag')
<title>افزودن رنگ برای {{$product->name}}</title>
...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb text-center">
        ...
        <li class="breadcrumb-item active font-size-12" aria-current="page">افزودن رنگ برای {{$product->name}}</li>
    </ol>
</nav>
<section class="row">
    ...
    <section class="col-12">
        <section class="main-body-container">
            <section class="main-body-container-header">
                <h4>افزودن رنگ جدید {{$product->name}}</h4>
            </section>
            <section class="d-flex justify-content-between align-items-center my-4">
                <a class="btn btn-dark btn-sm" href="{{route('admin.market.product-color.index', $product->id)}}">بازگشت</a>
                    ...
                    @csrf
                        ...
                        <section class="col-12 col-md-5 py-2">
                            <div class="form-group">
                                ...
                                <input class="form-control form-control-sm" type="text" value="{{old('color_name')}}"
                        ...
                        <section class="col-12 col-md-5 py-2">
                            <div class="form-group">
                                ...
                                <input class="form-control form-control-sm" type="color" value="{{old('color')}}"
                                    name="color" id="color">
                            </div>
                            @error('color')
                                <span class="alert_required text-danger" role="alert"><strong>{{$message}}</strong></span>
