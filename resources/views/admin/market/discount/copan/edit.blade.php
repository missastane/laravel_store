...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb text-center">
        ...
        <li class="breadcrumb-item active font-size-12" aria-current="page">ویرایش کوپن تخفیف</li>
    </ol>
</nav>
<section class="row">
                    ...
                    <section class="row">
                        ...
                        <section class="col-12 py-2">
                            <div class="form-group">
                                ...
                                <input class="form-control form-control-sm" value="{{old('code', $copan->code)}}" type="text"
                                    name="code" id="code">
                            </div>
                            @error('code')
                        ...
                        <section class="col-12 col-md-6 py-2">
                            <div class="form-group">
                                ...
                                <select class="form-control form-control-sm" name="amount_type" id="amount_type">
                                    <option value="2" @if (old('amount_type', $copan->amount_type) == 2) selected @endif>درصدی</option>
                                    <option value="1" @if (old('amount_type', $copan->amount_type) == 1) selected @endif>به تومان</option>
                                </select>
                            </div>
                            @error('amount_type')
                                <span class="alert_required text-danger" role="alert"><strong>{{$message}}</strong></span>
                        ...
                        <section class="col-12 col-md-6 py-2">
                            <div class="form-group">
                                ...
                                <input class="form-control form-control-sm" type="text" value="{{old('amount',$copan->amount)}}"
                        ...
                        <section class="col-12 col-md-6 py-2">
                            <div class="form-group">
                                ...
                                <select class="form-control form-control-sm" name="type" id="type">
                                    <option value="2" @if (old('type',$copan->type) == 2) selected @endif>عمومی</option>
                                    <option value="1" @if (old('type',$copan->type) == 1) selected @endif>اختصاصی برای کاربر</option>
                                </select>
                            </div>
                            @error('type')
                                <span class="alert_required text-danger" role="alert"><strong>{{$message}}</strong></span>
                        ...
                        <section class="col-12 col-md-6 py-2 @if ($copan->user_id == null)
                        d-none
                        @endif" id="type-private">
                            <div class="form-group">
                        ...
                        <section class="col-12 col-md-6 py-2">
                            <div class="form-group">
                                ...
                                <input class="form-control form-control-sm" type="text"
                                    value="{{old('discount_ceiling',$copan->discount_ceiling)}}" name="discount_ceiling" id="discount_ceiling">
                            </div>
                        ...
                        <section class="col-12 col-md-6 py-2">
                            <div class="form-group">
                                ...
                                <input class="form-control form-control-sm d-none" type="text" name="start_date"
                                    id="start_date">
                                <input class="form-control form-control-sm" value="{{old('start_date',$copan->start_date)}}" type="text"
                                    id="start_date_view">
                            </div>
                            @error('start_date')
                                <span class="alert_required text-danger" role="alert"><strong>{{$message}}</strong></span>
                        ...
                        <section class="col-12 col-md-6 py-2">
                            <div class="form-group">
                                ...
                                <input class="form-control form-control-sm" value="{{old('end_date',$copan->end_date)}}" type="text"
                                id="end_date_view">
                            </div>
                            @error('end_date')
                                <span class="alert_required text-danger" role="alert"><strong>{{$message}}</strong></span>
