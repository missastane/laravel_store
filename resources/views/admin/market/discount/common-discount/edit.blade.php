...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb text-center">
        ...
        <li class="breadcrumb-item font-size-12"><a href="{{route('admin.market.discount.commonDiscount')}}">تخفیف
                عمومی</a></li>
                    ...
                    <section class="row">
                        ...
                        <section class="col-12 col-md-6 py-2">
                            <div class="form-group">
                                ...
                                <input class="form-control form-control-sm"
                                    value="{{old('title', $commonDiscount->title)}}" type="text" name="title"
                                    id="title">
                            </div>
                            @error('title')
                        ...
                        <section class="col-12 col-md-6 py-2">
                            <div class="form-group">
                                ...
                                <input class="form-control form-control-sm"
                                    value="{{old('percentage', $commonDiscount->percentage)}}" type="text"
                        ...
                        <section class="col-12 col-md-6 py-2">
                            <div class="form-group">
                                ...
                                <input class="form-control form-control-sm" type="text"
                                    ...
                                    name="minimal_order_amount" id="minimal_order_amount">
                            </div>
                        ...
                        <section class="col-12 col-md-6 py-2">
                            <div class="form-group">
                                ...
                                <input class="form-control form-control-sm d-none" type="text" name="start_date"
                                    id="start_date">
                                <input class="form-control form-control-sm"
                                    value="{{old('start_date', $commonDiscount->start_date)}}" type="text"
                                    id="start_date_view">
                            </div>
                            @error('start_date')
                                <span class="alert_required text-danger" role="alert"><strong>{{$message}}</strong></span>
                        ...
                        <section class="col-12 col-md-6 py-2">
                            <div class="form-group">
                                ...
                                <input class="form-control form-control-sm d-none" type="text" name="end_date"
                                    id="end_date">
                                <input class="form-control form-control-sm"
                                    value="{{old('end_date', $commonDiscount->end_date)}}" type="text"
                                    id="end_date_view">
                            </div>
                            @error('end_date')
                                <span class="alert_required text-danger" role="alert"><strong>{{$message}}</strong></span>
