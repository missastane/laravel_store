...
@section('head-tag')
<title>ویرایش روش ارسال محصول</title>
...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb text-center">
        ...
        <li class="breadcrumb-item active font-size-12" aria-current="page">ویرایش روش ارسال محصول</li>
    </ol>
</nav>
<section class="row">
    <section class="col-12">
        <section class="main-body-container">
            <section class="main-body-container-header">
                <h4>ویرایش روش برای ارسال محصولات</h4>
            </section>
            ...
            <form action="{{route('admin.market.delivery.update', $delivery->id)}}" method="post">
                <section class="row">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control form-control-sm" value="{{old('name', $delivery->name)}}" type="text" name="name" id="name">
                    </div>
                    @error('name')
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control form-control-sm" type="number" value="{{old('amount', $delivery->amount)}}" name="amount" id="amount">
                    </div>
                    @error('amount')
                                <span class="alert_required text-danger" role="alert"><strong>{{$message}}</strong></span>
                            @enderror
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control form-control-sm" type="number" value="{{old('delivery_time', $delivery->delivery_time)}}" name="delivery_time" id="delivery_time">
                    </div>
                    @error('delivery_time')
                                <span class="alert_required text-danger" role="alert"><strong>{{$message}}</strong></span>
                            @enderror
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control form-control-sm" type="text" value="{{old('delivery_time_unit', $delivery->delivery_time_unit)}}" name="delivery_time_unit" id="delivery_time_unit">
                    </div>
                    ...
                    <section class="col-12">
                    <div class="form-group">
                        <button type="submit" class="btn btn-warning btn-sm float-left">ویرایش</button>
                    </div></section>
                </section/>
            </form>
            </section>
