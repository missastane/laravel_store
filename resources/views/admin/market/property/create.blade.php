...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb text-center">
        ...
        <li class="breadcrumb-item active font-size-12" aria-current="page">ایجاد فرم</li>
    </ol>
</nav>
<section class="row">
            ...
            <form action="{{route('admin.market.property.store')}}" method="post">
                <section class="row">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control form-control-sm" type="text" value="{{old('unit')}}" name="unit" id="unit">
                    </div>
                    @error('unit')
                                <span class="alert_required text-danger" role="alert"><strong>{{$message}}</strong></span>
                            @enderror
                ...
                <section class="col-12 d-flex flex-md-row flex-column align-items-center justify-content-md-center">
                    ...
                    <div class="col-12 col-md-6 mt-4 py-2">
