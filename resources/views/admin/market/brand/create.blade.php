                    ...
                    <section class="row">
                        ...
                        <section class="col-12 col-md-6 py-2">
                            <div class="form-group">
                                ...
                                <input class="form-control form-control-sm" value="{{old('persian_name')}}" type="text" name="persian_name"
                                    id="persian_name">
                            </div>
                            @error('persian_name')
                        ...
                        <section class="col-12 col-md-6 py-2">
                            <div class="form-group">
                                ...
                                <input class="form-control form-control-sm" value="{{old('original_name')}}" type="text" name="original_name"
                                    id="original_name">
                            </div>
                            @error('original_name')
                                <span class="alert_required text-danger" role="alert"><strong>{{$message}}</strong></span>
