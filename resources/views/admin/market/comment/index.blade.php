    ...
    <section class="col-12">
        <section class="main-body-container">
            ...
            <section class="d-flex justify-content-between align-items-center my-4">
                ...
                <form method="GET" action="{{route('admin.market.comment.search')}}" class="max-width-16-rem">
                            ...
                            <tr>
                                ...
                                <td class="width-16-rem text-left">
                                    <a class="btn btn-sm btn-info"
                                        href="{{route('admin.market.comment.show', $comment->id)}}"><i
                                    ...
                                    @if ($comment->approved == 2)
                                        <a id="{{$comment->id}}_approved" class="btn btn-sm btn-success text-white"
                                            ...
                                            data-approved-url="{{route('admin.market.comment.approved', $comment->id)}}"><i
