                    ...
                    <section class="row">
                        ...
                        <section class="col-12 col-md-6 py-2">
                            <div class="form-group">
                                ...
                                <input class="form-control form-control-sm" value="{{old('first_name', $admin->first_name)}}" type="text"
                        ...
                        <section class="col-12 col-md-6 py-2">
                            <div class="form-group">
                                ...
                                <input class="form-control form-control-sm" value="{{old('last_name', $admin->last_name)}}" type="text"
                        ...
                        <section class="col-12 col-md-6 py-2">
                            ...
                            <div class="form-group">
                                <section class="row">
                                    ...
                                    <section class="col-12 col-md-6 py-2">
                                        <img class="preUpload-preview-img" @if ($admin->profile_photo_path != null)
                        ...
                        <section class="col-12 col-md-6 py-2">
                            <div class="form-group">
                                ...
                                <select class="form-control form-control-sm" name="activation" id="activation">
                                    ...
                                    <option value="2" @if (old('activation', $admin->activation) == 2) selected @endif>غیرفعال</option>
                                </select>
                            </div>
                            @error('activation')
                                <span class="alert_required text-danger" role="alert"><strong>{{$message}}</strong></span>
