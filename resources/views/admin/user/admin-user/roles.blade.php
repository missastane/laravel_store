...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb text-center">
        ...
        <li class="breadcrumb-item active font-size-12" aria-current="page">ایجاد نقش ادمین</li>
    </ol>
</nav>
<section class="row">
    <section class="col-12">
        <section class="main-body-container">
            ...
            <section>
                <form action="{{route('admin.user.admin-user.roles-store', $admin->id)}}" method="post">
                    <section class="row">
                        @csrf
                        <section class="col-12 py-2">
                            <div class="form-group">
                                ...
                                <select class="form-control form-control-sm js-example-basic-single" 
                                   ...
                                   <option value="{{$role->id}}" @foreach ($admin->roles as $adminRole)
