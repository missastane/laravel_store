                    ...
                    <section class="row">
                        ...
                        <section class="col-12 py-2 col-md-10">
                            <div class="form-group">
                                ...
                                <input class="form-control form-control-sm" value="{{old('description')}}" type="text" name="description" id="description">
                            </div>
                            @error('description')
                                <span class="alert_required text-danger" role="alert"><strong>{{$message}}</strong></span>
                            @enderror
                        ...
                        <section class="col-12 py-2 col-md-2">
                            <button type="submit" class="btn btn-success btn-sm mt-2-rem">ثبت</button>
                    </section>
            </section>
                ...
                <section class="col-12 col-md-3">
                    <div class="form-check">
                        <input class="form-check-input" 
                            type="checkbox" name="permission_id[]" value="{{$permission->id}}" id="check1{{$permission->id}}">
                        <label class="form-check-label mr-3 mt-1 d-inline" for="check1{{+$permission->id}}">{{$permission->name}}</label>

                    </div>
                    @error('permission_id.'.$key)
                                <span class="alert_required text-danger" role="alert"><strong>{{$message}}</strong></span>
                            @enderror
                </section>
                @endforeach
