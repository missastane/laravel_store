                    ...
                    <section class="row">
                        ...
                        <section class="col-12 py-2 col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control form-control-sm" name="commentable" id="commentable">
                                    <option value="1"  value="1" @if(old('commentable') == 1) selected  @endif>بله</option>
                                    <option value="2" @if(old('commentable') == 1) selected  @endif>خیر</option>
                                </select>
                            </div>
                            @error('commentable')
                                <span class="alert_required text-danger" role="alert"><strong>{{$message}}</strong></span>
                        ...
                        <section class="col-12 py-2 col-md-6">
                            <div class="form-group">
                                ...
                                <option @if (old('post_category_id') == $postCategory->id)
                                selected
                        ...
                        <section class="col-12 py-2">
                            <div class="form-group">
                                ...
                                <textarea class="form-control form-control-sm" name="summary" id="summary" rows="7">{{old('summary')}}</textarea>
                            </div>
                            @error('summary')
                                <span class="alert_required text-danger" role="alert"><strong>{{$message}}</strong></span>
                            @enderror
                        ...
                        <section class="col-12 py-2">
                            <div class="form-group">
                                ...
                                <textarea class="form-control form-control-sm" name="body" id="body" rows="12">{{old('body')}}</textarea>
                            </div>
                            @error('body')
                                <span class="alert_required text-danger" role="alert"><strong>{{$message}}</strong></span>
                            @enderror
