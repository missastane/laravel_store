                    ...
                    <section class="row">
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control form-control-sm" value="{{old('name', $postCategory->name)}}"
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control form-control-sm" name="status" id="status">
                                    <option value="1" @if (old('status', $postCategory->status) == 1) selected @endif>
                                        فعال</option>
                                    <option value="2" @if (old('status', $postCategory->status) == 2) selected @endif>
                                        غیرفعال</option>
                                </select>
                            </div>
                            @error('status')
                        ...
                        <section class="col-12 mt-md-1">
                            <div class="form-group">
                                <section class="row">
                                    ...
                                    <section class="col-12 col-md-6">
                                        @if ($postCategory->image != null)
                                            <img class="preUpload-preview-img"
                                                src="{{$postCategory->image['indexArray'][$postCategory->image['currentImage']]}}"
                                                alt="" id="logopreview">
                                                                ...
                                                                <section class="col-md-{{(6 / $number)}}">
                                                                    <div class="form-check">
                                                                        <input type="radio" class="form-check-input" value="{{$key}}"
                                                                            name="currentImage" id="{{$number}}" @if ($postCategory->image['currentImage'] == $key) checked @endif>
