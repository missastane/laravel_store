...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb text-center">
        ...
        <li class="breadcrumb-item active font-size-12" aria-current="page">ویرایش بنر</li>
    </ol>
</nav>
<section class="row">
                    ...
                    <section class="row">
                        ...
                        <section class="col-12 col-md-6 py-2">
                            <div class="form-group">
                                ...
                                <input class="form-control form-control-sm" value="{{old('title', $banner->title)}}" type="text" name="title"
                                    id="title">
                            </div>
                            @error('title')
                        ...
                        <section class="col-12 col-md-6 py-2">
                            <div class="form-group">
                                ...
                                <input title="نمونه آدرس معتبر : https://www.google.com/everything یا http://google.com/everything" class="form-control form-control-sm" value="{{old('url',$banner->url)}}" type="text" name="url"
                                    id="url">
                            </div>
                            @error('url')
                                <span class="alert_required text-danger" role="alert"><strong>{{$message}}</strong></span>
                        ...
                        <section class="col-12 py-2 col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control form-control-sm" name="status" id="status">
                                    ...
                                    <option value="2" @if(old('status', $banner->status) == 2) selected @endif>غیرفعال</option>
                                </select>
                            </div>
                            @error('status')
                                <span class="alert_required text-danger" role="alert"><strong>{{$message}}</strong></span>
                                ...
                                <section class="row">
                                    ...
                                    <section class="col-12 col-md-6">
                                        <img class="preUpload-preview-img"
                                            src="{{asset($banner->image)}}" alt="{{$banner->persian_name}}" id="logopreview">
                                    </section>
                                </section>
                            </div>
                            @error('image')
