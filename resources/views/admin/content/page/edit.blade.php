            ...
            <form action="{{route('admin.content.page.update', $page->id)}}" method="post">
                <section class="row">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control form-control-sm" value="{{old('title', $page->title)}}" type="text" name="title" id="title">
                    </div>
                    @error('title')
                ...
                <section class="col-12">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control form-control-sm" name="status" id="status">
                                    <option value="1" @if (old('status', $page->status) == 1) selected @endif>
                                        فعال</option>
                                    <option value="2" @if (old('status', $page->status) == 2) selected @endif>
                                        غیرفعال</option>
                                </select>
                            </div>
                            @error('status')
                  ...
                  <textarea name="body" id="body" rows="5">{{old('body', $page->body)}}</textarea>
