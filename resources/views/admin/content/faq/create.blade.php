...
@section('head-tag')
<title>ایجاد سؤال و جواب جدید</title>
...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb text-center">
        ...
        <li class="breadcrumb-item active font-size-12" aria-current="page">ایجاد سؤال و جواب جدید</li>
    </ol>
</nav>
<section class="row">
            ...
            <form action="{{route('admin.content.faq.store')}}" method="post">
                <section class="row">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control form-control-sm" type="text" value="{{old('question')}}" name="question" id="question">
                    </div>
                    @error('question')
                  ...
                  <textarea class="form-control form-control-sm" name="answer" id="answer" rows="10">{{old('answer')}}</textarea>
                    </div>
                    @error('answer')
                                <span class="alert_required text-danger" role="alert"><strong>{{$message}}</strong></span>
                            @enderror
