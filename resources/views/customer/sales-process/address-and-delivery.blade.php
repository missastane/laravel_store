...
@section('head-tag')
<title>انتخاب آدرس و نحوه ارسال</title>
@endsection
                ...
                <section class="row mt-4">
                    <section class="col-md-9">
                        <section class="content-wrapper bg-white p-3 rounded-2 mb-4">
                            ...
                            @error('address_id')
                                ...
                                @foreach (auth()->user()->addresses as $address)
                                    ...
                                    <input type="radio" form="address-and-delivery" name="address_id" value="{{$address->id}}" id="address_{{$address->id}}" />
                                    <!--checked="checked"-->
                        ...
                        <section class="content-wrapper bg-white p-3 rounded-2 mb-4">
                            ...
                            <section class="delivery-select ">
                              ...
                              <section class="w-100">
                              @error('delivery_id')
                                                                <span class="alert_required text-danger p-1 rounded my-1"
                                                                    role="alert">
                                                                    <strong>
                                                                        {{ $message }}
                                                                    </strong>
                                ...
                                <input type="radio" form="address-and-delivery" name="delivery_id" value="{{$method->id}}" id="delivery_{{$method->id}}" />
                                <label for="delivery_{{$method->id}}" class="col-12 col-md-4 delivery-wrapper mt-1 mb-2 pt-2">
                                    <section class="mb-2">
                                    ...
                                    <section class="mb-2">
                                        <i class="fa fa-credit-card mx-1"></i>
                                         با هزینه ارسال {{priceFormat($method->amount)}} تومان
                                    </section>
                                    <section class="mb-2">
                                        <i class="fa fa-calendar-alt mx-1"></i>
                                        تامین کالا از {{$method->delivery_time.' '.$method->delivery_time_unit}} آینده
                                    </section>
                                </label>
                    ...
                    <section class="col-md-3">
                        <section class="content-wrapper bg-white p-3 rounded-2 cart-total-price">
                            ...
                            <form action="{{route('customer.sales-process.choose-address-and-delivery')}}" method="post" id="address-and-delivery">
                                @csrf
                            </form>
                            <section class="">
                                <button type="button" onclick="document.getElementById('address-and-delivery').submit();"
