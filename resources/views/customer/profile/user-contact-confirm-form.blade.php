...
<title>تایید موبایل یا ایمیل</title>
@endsection
@section('content')
<section class="vh-100 d-flex justify-content-center align-items-center pb-5">
    <form action="{{route('customer.profile.user-contact-confirm', $token)}}" method="post">
        <section class="login-wrapper mb-5">
            ...
            <section id="resend-otp" class="d-none">
                <a class="text-decoration-none text-primary"
                    href="{{route('customer.profile.resend-otp', $token)}}">دریافت مجدد کد تأیید</a>
            </section>
