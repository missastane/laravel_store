                            ...
                            <section class="main-body-container">
                                ...
                                <section class="float-right">
                                    <a href="{{route('customer.profile.orders')}}"
                                        class="btn btn-sm btn-dark text-white">بازگشت</a>

                                </section>
                                <section class="float-left">
                                    <a id="print" class="btn btn-sm btn-dark text-white">چاپ</a>
                                    <a href="{{route('customer.profile.order-detail', $order->id)}}"
                                        class="btn btn-sm btn-info text-white">جزئیات</a>

                                </section>
                                <section class="table-responsive mt-5" id="printable">
                                    ...
                                    <table class="table table-striped text-center">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="border-bottom">
                                                <th>واحد</th>
                                                <td class="text-left font-weight-bolder">
                                                    {{$order->address->unit ?? '-'}}</td>
                                            </tr>
                                            <tr class="border-bottom">
                                                <th>پلاک</th>
                                                <td class="text-left font-weight-bolder">{{$order->address->no ?? '-'}}
                                                </td>
                                            </tr>
                                            <tr class="border-bottom">
                                                <th>کد پستی</th>
                                                <td class="text-left font-weight-bolder">
                                                    {{$order->address->postal_code ?? '-'}}</td>
                                            </tr>
                                            <tr class="border-bottom">
                                                <th>نام گیرنده</th>
                                                <td class="text-left font-weight-bolder">
                                            ...
                                            <tr class="border-bottom">
                                                <th>شماره موبایل</th>
                                                <td class="text-left font-weight-bolder">
                                                    {{$order->address->mobile ?? '-'}}</td>
                                            </tr>
                                            <tr class="border-bottom">
                                                <th>نوع پرداخت</th>
                                                <td class="text-left font-weight-bolder">
                                                    {{$order->payment_type_value ?? '-'}}</td>
                                            </tr>
                                            <tr class="border-bottom">
                                                <th>وضعیت پرداخت</th>
                                                <td class="text-left font-weight-bolder">
                                            ...
                                            <tr class="border-bottom">
                                                <th>بانک</th>
                                                <td class="text-left font-weight-bolder">
                                                    {{$order->payment->gateway ?? '-'}}</td>
                                            </tr>
                                            <tr class="border-bottom">
                                                <th>هزینه ارسال</th>
                                                <td class="text-left font-weight-bolder">
                                                    {{number_format($order->delivery->amount) ?? '0'}}
                                                    تومان</td>
                                            </tr>
                                            <tr class="border-bottom">
                                                <th>وضعیت ارسال</th>
                                                <td class="text-left font-weight-bolder">
                                                    {{$order->delivery_status_value ?? '-'}}</td>
                                            </tr>
                                            <tr class="border-bottom">
                                                <th>تاریخ ارسال</th>
                                                <td class="text-left font-weight-bolder">
                                            ...
                                            <tr class="border-bottom">
                                                ...
                                                <td class="text-left font-weight-bolder">{{$order->copan->code ?? '-'}}
                                                </td>
                                            </tr>
                                            <tr class="border-bottom">
                                            ...
                                            <tr class="border-bottom">
                                                ...
                                                <td class="text-left font-weight-bolder">
                                                    {{$order->commonDiscount->title ?? '-'}}</td>
                                            </tr>
                                            <tr class="border-bottom">
                                                <th>مبلغ تخفیف عمومی استفاده شده</th>
                                                <td class="text-left font-weight-bolder">
                                                    {{$order->commonDiscount->percentage ?? '0'}} %
                                                </td>
                                            </tr>
                                            <tr class="border-bottom">
                                                <th>مجموع مبلغ تخفیف همه محصولات</th>
                                                <td class="text-left font-weight-bolder">
                                                    {{number_format($order->order_total_products_discount_amount) ?? '0'}}
                                                    تومان
                                                </td>
                                            </tr>
                                            <tr class="border-bottom">
